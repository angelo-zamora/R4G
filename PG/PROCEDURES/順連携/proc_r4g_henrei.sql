...
BEGIN
   ...
   OPEN cur_main;
      LOOP
         ...
         rec_henrei.henrei_toroku_ymd := CASE WHEN rec_main.henrei_toroku_ymd IS NULL OR rec_main.henrei_toroku_ymd ='0000-00-00' THEN 0 ELSE get_date_to_num(to_date(rec_main.henrei_toroku_ymd, 'yyyy-mm-dd')) END;
         rec_henrei.henrei_ymd := CASE WHEN rec_main.henrei_ymd IS NULL OR rec_main.henrei_ymd ='0000-00-00' THEN 0 ELSE get_date_to_num(to_date(rec_main.henrei_ymd, 'yyyy-mm-dd')) END;
         rec_henrei.henrei_jiyu_cd := rec_main.henrei_jiyu;
         rec_henrei.saihasso_ymd := CASE WHEN rec_main.re_hasso IS NULL OR rec_main.re_hasso ='0000-00-00' THEN 0 ELSE get_date_to_num(to_date(rec_main.re_hasso, 'yyyy-mm-dd')) END;
         rec_henrei.koji_ymd := CASE WHEN rec_main.kouji_ymd IS NULL OR rec_main.kouji_ymd ='0000-00-00' THEN 0 ELSE get_date_to_num(to_date(rec_main.kouji_ymd, 'yyyy-mm-dd')) END;
         rec_henrei.koji_sotatsu_ymd := CASE WHEN rec_main.koji_sotatsu_ymd IS NULL OR rec_main.koji_sotatsu_ymd ='0000-00-00' THEN 0 ELSE get_date_to_num(to_date(rec_main.koji_sotatsu_ymd, 'yyyy-mm-dd')) END;
         rec_henrei.henkomae_noki_ymd := CASE WHEN rec_main.noki_henko_mae IS NULL OR rec_main.noki_henko_mae ='0000-00-00' THEN 0 ELSE get_date_to_num(to_date(rec_main.noki_henko_mae, 'yyyy-mm-dd')) END;
         rec_henrei.henkogo_noki_ymd := CASE WHEN rec_main.noki_henko_ato IS NULL OR rec_main.noki_henko_ato ='0000-00-00' THEN 0 ELSE get_date_to_num(to_date(rec_main.noki_henko_ato, 'yyyy-mm-dd')) END;
